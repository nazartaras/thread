...
export const DISLIKE_POST = 'POST_ACTION:DISLIKE_POST';
export const DELETE_POST = 'POST_ACTION:DELETE_POST';
export const RESTORE_POST='POST_ACTION:RESTORE_POST';
export const UPDATE_POST = 'POST:ACTION:UPDATE_POST';
export const DELETE_COMMENT = 'POST_ACTION:DELETE_COMMENT';
export const RESTORE_COMMENT='POST_ACTION:RESTORE_COMMENT';
export const UPDATE_COMMENT = 'POST:ACTION:UPDATE_COMMENT';